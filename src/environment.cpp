...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud)
{
    ...
    inputCloud = pointProcessorI->FilterCloud(inputCloud, 0.1, Eigen::Vector4f (-10, -5.0, -2.0, 1), Eigen::Vector4f ( 30, 5.0, 1.0, 1));
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->Clustering(segmentCloud.first, 0.3, 30, 2000);
